...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  ...
  [registrar registerViewFactory:[[FLTNativeAudienceFactory alloc] initWithMessenger:[registrar messenger]]  withId:@"nativeAudience"];
  [registrar registerViewFactory:[[FLTBannerAudienceFactory alloc] initWithMessenger:[registrar messenger]]  withId:@"bannerAudience"];
...
- (void)callLoadInterstitialAd:(FLTMobileAd *)ad
  ...
  NSString *adUnitId = (NSString *)call.arguments[@"adUnitId"];
  if ([adUnitId isKindOfClass:[NSNull class]] || ((NSString *)adUnitId).length == 0) {
    NSString *message =
